...
class Home extends React.Component {
  ...
  fetchorderdelete= (dd)=>{
    ...
    console.log(fd);
   fetch('api/api.php?action=orderdelete', 
   {
       method: 'POST',
       body: fd,
       credentials: 'include'
  ...
  completeorder=()=>{
    fetch('api/api.php?action=sumtotalprice', 
    {
        method: 'GET',
        credentials: 'include'
    })
  ...
  componentDidMount() {
    ...
    fetch('api/api.php?action=displayorderfood',
    {
            method: 'POST',
            credentials: 'include'
        }
    ...
    fetch('api/api.php?action=showorderform',
        {
                method: 'GET',
                credentials: 'include'
            }
  ...
  handleSubmit(event) {
    ...
    fetch('api/api.php?action=login', {
      ...
      if(headers.status == 200) {
        ...
        this.setState({ redirect: true });
        fetch('api/api.php?action=createorder', 
        {
            method: 'POST',
            credentials: 'include'
        })
...
class payment extends React.Component {
  ...
  handleSubmit(event){
    ...
    .catch(function(error) {console.log(error)});
    fetch('api/api.php?action=checkoutupdate', 
    {
        method: 'POST',
        credentials: 'include'
    })
  ...
  componentDidMount(){
    fetch('api/api.php?action=confirmorderform',
    {
            method: 'GET',
            credentials: 'include'
        }
